...
public class Graphic extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setBounds(617, 0, 53, 23);
        ...
        jButton6.setBounds(676, 0, 61, 23);
        ...
        jTabbedPane1.setBounds(0, 90, 750, 440);
        getContentPane().add(jLabel2);
        jLabel2.setBounds(160, 0, 450, 120);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     String word = jTextField1.getText().trim().toLowerCase();
        ...
        if(hm.containsKey(word))
        {
            ...
            mean = "<html><body><font color='red'>This word doesn't exist in Data. Please search Google.com</font></body></html>";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       ...
       JOptionPane.showMessageDialog(rootPane, "Copy one or all of link below and paste to browser" + "\n" + "Google.com" + "\n" + "Stackoverflow.com","Help" , JOptionPane.QUESTION_MESSAGE);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        JOptionPane.showMessageDialog(rootPane, "Author : Le Hai Dang and Dao Anh Duc" + "\n" + "Contact us: Pro_Duc and NganTu" + "\n" + "Relax and give me good mark", "About", JOptionPane.INFORMATION_MESSAGE);
    ...
    public int searchBinary(String str, ArrayList<String> a)
    {
        if (a.get(0).compareTo(str)>=0) return 0;
        int d = 0, c = a.size();
        while (d<c-1){
            int g = (d+c)/2;
            if (a.get(g).compareTo(str)<0) d=g;else c=g;
        }
        return c;
    }
